...
function length(string) {
    ...
    // return the length of the sting should be a number value 
...
let newString = '';
// use lower case method to change the case of the string to lower case. 
...
// create an empty string 
let string2 = " ";
//use toUpperCase method to change string to all Upper case letters
